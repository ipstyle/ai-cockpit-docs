...
**Fertig vorbereitet, noch nicht eingereicht: 6.5.** Ein achter Anbieter,
...
- **GitHub Copilot** *(kommt mit 6.5, noch nicht eingereicht)* — Premium-Anfragen aus einem privat bezahlten Abo; ein
